/*
  ...
  1.6.1
  - Увеличен лимит таймаута привода
  - При переходе настройки сбросятся!

  1.6.2 - добавлена поддержка HTU21D (заменяет BME280)
  1.6.3 - исправлена ошибка с серво (ошибка компиляции была)
  1.6.4 - актуализированы библиотеки
*/
