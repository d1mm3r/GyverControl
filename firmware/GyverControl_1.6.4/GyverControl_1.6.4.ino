...
// Версия 1.6.3 - исправлена ошибка с серво (ошибка компиляции была)
// Версия 1.6.4 - актуализированы библиотеки
...
// ==================== ПИД ====================
#define USE_PID 1             // включает/отключает поддержку ПИД регулятора на каналах 2, 3, серво1, серво2 и привода
...
#define DALLAS_AMOUNT 3     // количество далласов на ОДНОМ пине
...
#define DALLAS_DISP 1       // ОТОБРАЖЕНИЕ показаний:
...
#if (DALLAS_AMOUNT > 1)
const uint64_t dsAddress[] = {
  0x28FF425A51174D2, // адрес датчика 1
  0x28FF53E550174C3, // адрес датчика 2
  0x28FF9980501744D, // адрес датчика 3
...
#define DHT_SENS2 1         // 1 - ко входу SENS2 подключен DHT11/DHT22, 0 - подключен обычный аналоговый датчик
